...
pref("__prefsPrefix__.geminiSystemPrompt", "あなたは優秀なアシスタントです。提供されたコンテキストに基づいて質問に答えてください。回答は必ず日本語で行い、数式にはKatexを使用したマークダウン形式で記述してください。一般的な事実に対してはGoogle検索を使用し、信頼できる情報源に基づいて正確に答えてください。");
